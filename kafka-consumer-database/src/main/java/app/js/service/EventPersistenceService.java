...
public class EventPersistenceService {
    ...
    public EventPersistenceService(
        ...
        this.eventsPersistedCounter = Counter.builder("wikimedia.events.persisted")
                .description("Total number of events persisted to MongoDB")
                .register(meterRegistry);

        this.eventsDlqCounter = Counter.builder("wikimedia.events.dlq")
        ...
        log.info("EventPersistenceService started with queue capacity: {}, batch size: {}, flush interval: {}ms",
