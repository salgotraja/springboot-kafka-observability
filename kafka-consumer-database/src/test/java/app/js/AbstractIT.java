...
public abstract class AbstractIT {
  ...
  @Autowired protected WikimediaEventRepository eventRepository;

  @Autowired protected FailedEventRepository failedEventRepository;

  @Autowired protected EventPersistenceService persistenceService;

  @Autowired protected KafkaContainer kafkaContainer;
