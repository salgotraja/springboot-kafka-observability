...
class WikimediaChangesProducerIntegrationTest {
  ...
  @Container static KafkaContainer kafka = new KafkaContainer("apache/kafka-native:3.8.0");

  @DynamicPropertySource
  static void overrideProperties(DynamicPropertyRegistry registry) {
    registry.add("spring.kafka.producer.bootstrap-servers", kafka::getBootstrapServers);
    registry.add(
        "app.wikimedia.stream-url", () -> "https://stream.wikimedia.org/v2/stream/recentchange");
  }
